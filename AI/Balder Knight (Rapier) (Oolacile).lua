--@package: m12_01_00_00.luabnd, 256012_battle.lua
--@battle_goal: 256012, LightKnight_Rapier256012Battle
...
OnIf_256012 = function(ai, goal, func1_param2)
...
LightKnight_Rapier256012Battle_Activate = function(ai, goal)
   local func2_var2 = 0
   local func2_var3 = 5
   local func2_var4 = 30
   ...
   func2_var10 = func2_var10(ai, goal, LightKnight_Rapier256012_Act04)
...
LightKnight_Rapier256012_Act04 = function(ai, goal, func3_param2)
...
LightKnight_Rapier256012Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

LightKnight_Rapier256012Battle_Terminate = function(ai, goal)
end

LightKnight_Rapier256012Battle_Interupt = function(ai, goal)
   if ai:IsLadderAct(TARGET_SELF) then
      return false
   end
