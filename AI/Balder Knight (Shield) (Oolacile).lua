--@package: m12_01_00_00.luabnd, 256010_battle.lua
--@battle_goal: 256010, LightKnight_Sword256010Battle
...
OnIf_256010 = function(ai, goal, func1_param2)
...
LightKnight_Sword256010Battle_Activate = function(ai, goal)
   local func2_var2 = {}
   local func2_var3 = {}
   local func2_var4 = {}
   ...
   func2_var7 = func2_var7(ai, goal, LightKnight_Sword256010_Act08)
...
LightKnight_Sword256010_Act05 = function(ai, goal, func3_param2)
...
LightKnight_Sword256010_Act06 = function(ai, goal, func4_param2)
   goal:AddSubGoal(GOAL_COMMON_Attack, 10, 3008, TARGET_SELF, DIST_None)
   GetWellSpace_Odds = 0
   return GetWellSpace_Odds
end

LightKnight_Sword256010_Act08 = function(ai, goal, func5_param2)
...
LightKnight_Sword256010Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

LightKnight_Sword256010Battle_Terminate = function(ai, goal)
end

LightKnight_Sword256010Battle_Interupt = function(ai, goal)
   if ai:IsLadderAct(TARGET_SELF) then
      return false
   end
