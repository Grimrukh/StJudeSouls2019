--@package: m12_01_00_00.luabnd, 255011_battle.lua
--@battle_goal: 255011, HusiHeavy_Long255011Battle
...
OnIf_255011 = function(ai, goal, func1_param2)
...
HusiHeavy_Long255011Battle_Activate = function(ai, goal)
   local func2_var2 = {}
   local func2_var3 = {}
   local func2_var4 = {}
   ...
   func2_var8 = func2_var8(ai, goal, HusiHeavy_Long255011_Act02)
   ...
   func2_var8 = REGIST_FUNC
   func2_var8 = func2_var8(ai, goal, HusiHeavy_Long255011_Act05)
   func2_var3[5] = func2_var8
   func2_var8 = REGIST_FUNC
   func2_var8 = func2_var8(ai, goal, HusiHeavy_Long255011_Act07)
   func2_var3[7] = func2_var8
   func2_var8 = REGIST_FUNC
   func2_var8 = func2_var8(ai, goal, HusiHeavy_Long255011_Act08)
...
HusiHeavy_Long255011_Act02 = function(ai, goal, func3_param2)
...
HusiHeavy_Long255011_Act05 = function(ai, goal, func4_param2)
...
HusiHeavy_Long255011_Act07 = function(ai, goal, func5_param2)
...
HusiHeavy_Long255011_Act08 = function(ai, goal, func6_param2)
...
HusiHeavy_Long255011Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

HusiHeavy_Long255011Battle_Terminate = function(ai, goal)
end

HusiHeavy_Long255011Battle_Interupt = function(ai, goal)
