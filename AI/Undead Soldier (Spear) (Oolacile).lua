--@package: m12_01_00_00.luabnd, 255010_battle.lua
--@battle_goal: 255010, HusiHeavy_Spear255010Battle
...
OnIf_255010 = function(ai, goal, func1_param2)
...
HusiHeavy_Spear255010Battle_Activate = function(ai, goal)
   ...
   elseif func2_var16 == 1 and func2_var17 == ROLE_TYPE_Kankyaku then
      ...
      elseif func2_var19 <= func2_var10 + func2_var11 then
         ...
         HusiHeavy_Spear255010_AfterAttackAct01(ai, goal)
...
HusiHeavy_Spear255010_AfterAttackAct01 = function(ai, goal)
   local func3_var2 = 0
   local func3_var3 = 85
   local func3_var4 = 0
   local func3_var5 = 0
...
HusiHeavy_Spear255010Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

HusiHeavy_Spear255010Battle_Terminate = function(ai, goal)
end

HusiHeavy_Spear255010Battle_Interupt = function(ai, goal)
